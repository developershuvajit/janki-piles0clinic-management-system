...
<head>
    ...
    <title><?= esc($title ?? 'Admin Panel') ?> — Janki Piles Clinic</title>
...
<body>
    ...
    <div class="admin-wrapper">
        ...
        <!-- ========== MAIN CONTENT ========== -->
        <main class="admin-content" style="flex: 1; min-width: 0;">
                ...
                <div class="topbar-actions">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-clean">
                            ...
                            <li><a class="dropdown-item" href="<?= site_url('/admin/billing/create') ?>"><i class="bi bi-receipt text-info"></i> Create Bill</a></li>
                            <li><a class="dropdown-item" href="<?= site_url('/admin/inventory/add') ?>"><i class="bi bi-capsule text-danger"></i> Add Medicine</a></li>
                        </ul>
                    </div>
