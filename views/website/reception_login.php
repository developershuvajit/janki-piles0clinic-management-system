        ...
        <div class="row justify-content-center">
            <div class="col-md-5 col-lg-4">
                <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                    <div class="card-header bg-emerald text-white text-center py-4 border-0" style="background: linear-gradient(135deg, #059669, #047857);">
                        <div class="mb-2">
                            <i class="bi bi-person-workspace fs-1"></i>
                        </div>
                        <h4 class="fw-bold mb-1">Reception Portal</h4>
                        <p class="small text-white-50 mb-0">Staff & OPD Front Desk Sign In</p>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form action="<?= site_url('/login') ?>" method="POST">
                            <?= csrf_field() ?>
                            <input type="hidden" name="portal_target" value="reception">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="username" name="username" value="<?= esc(\App\Helpers\Session::getFlash('old_username') ?? '') ?>" placeholder="Enter reception username" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="<?= site_url('/forgot-password') ?>" class="small text-emerald fw-bold text-decoration-none">Forgot Password?</a>
                            </div>

                            <button type="submit" class="btn btn-emerald w-100 py-2.5 rounded-3 fw-bold shadow-sm">
                                <i class="bi bi-box-arrow-in-right me-2"></i> Access Reception Console
                            </button>
                        </form>
                    </div>
                    <div class="card-footer bg-light text-center py-3 border-0">
                        <span class="small text-muted">Authorized Reception Staff Only</span>
                    </div>
                </div>
            </div>
        </div>
