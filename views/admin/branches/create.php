...
<div class="card border-0 shadow-sm p-4">
    <form action="<?= site_url('/admin/branches/save') ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
        <?= csrf_field() ?>

        <h5 class="fw-bold text-slate mb-3"><i class="bi bi-building-add text-success me-2"></i>Branch Profile details</h5>
        
        <div class="row g-3 mb-4">
            <div class="col-md-6">
                <label for="name" class="form-label small fw-semibold">Branch Name <span class="text-danger">*</span></label>
                <input type="text" class="form-control form-control-sm" id="name" name="name" required placeholder="e.g. City Dental Branch">
            </div>
            
            <div class="col-md-6">
                <label for="logo" class="form-label small fw-semibold">Branch Logo Image</label>
                <input type="file" class="form-control form-control-sm" id="logo" name="logo" accept="image/*">
                <div class="form-text x-small text-muted" style="font-size: 0.75rem;">Supported formats: JPEG, PNG. Max size: 2MB.</div>
            </div>
            
            <div class="col-md-12">
                <label for="address" class="form-label small fw-semibold">Physical Address <span class="text-danger">*</span></label>
                <textarea class="form-control" id="address" name="address" rows="2" required placeholder="Enter full address of the branch"></textarea>
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-sm" id="emergency_number" name="emergency_number" required placeholder="e.g. +91 99999 88888">
            </div>
            
            <div class="col-md-4">
                <label for="email" class="form-label small fw-semibold">Email Address <span class="text-danger">*</span></label>
                <input type="email" class="form-control form-control-sm" id="email" name="email" required placeholder="e.g. citybranch@clinic.com">
            </div>
            
            <div class="col-md-6">
                <label for="opening_hours" class="form-label small fw-semibold">Opening Hours <span class="text-danger">*</span></label>
                <input type="text" class="form-control form-control-sm" id="opening_hours" name="opening_hours" required placeholder="e.g. Mon-Sat: 09:00 AM - 08:00 PM">
            </div>
            ...
            <div class="col-md-12">
                ...
                <textarea class="form-control" id="google_map_link" name="google_map_link" rows="2" placeholder="Paste iframe source link or standard maps URL location"></textarea>
            </div>
        </div>
        ...
        <div class="text-end pt-3">
            ...
            <button type="submit" class="btn btn-primary btn-sm px-4 shadow-sm">
                <i class="bi bi-save me-1"></i> Save Branch Location
            </button>
        </div>
    </form>
</div>
