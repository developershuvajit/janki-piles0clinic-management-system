...
<div class="card border-0 shadow-sm p-5 receipt-container mx-auto" style="max-width: 800px; background: #fff;">
    ...
    <div class="row align-items-center mb-4 pb-4 border-bottom">
        ...
        <div class="col-6 text-end">
            ...
            <span class="badge bg-success px-3 py-1.5 rounded-pill fw-semibold">PAID IN FULL</span>
    ...
    <div class="row mb-4 bg-light p-3 rounded-3 mx-0">
        ...
        <div class="col-6 text-end">
            <div class="text-muted x-small text-uppercase fw-bold mb-1">Payment Method:</div>
            <div class="fw-bold text-slate"><?= esc(strtoupper($bill['payment_method'])) ?></div>
            <div class="text-muted small mt-2">
                Transaction Status: <strong>Settled</strong><br>
                Total Paid Amount: <strong class="text-success">₹<?= esc(number_format((float)$bill['paid_amount'], 2)) ?></strong>
            </div>
        </div>
    </div>
    ...
    <div class="row justify-content-end text-slate small">
        <div class="col-md-5">
            ...
            <div class="row g-2 align-items-center">
                <div class="col-6 fw-bold text-slate fs-5">Amount Collected:</div>
